...
import { ShowQuizResultComponent } from 'src/app/Components/Student/show-quiz-result/show-quiz-result.component';
...
sname:any;
  constructor(private myRoute: ActivatedRoute,
    ...
    this.IdParams = myRoute.snapshot.paramMap.get('lid');
    this.StudentId = myRoute.snapshot.paramMap.get('sid');
    this.sname= myRoute.snapshot.paramMap.get('n')
